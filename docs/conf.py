#!/usr/bin/env python
"""
 SubtitleToAudio documentation build configuration file.
...
src_path = os.path.abspath(
    os.path.join(docs_src_path, "..", " SubtitleToAudio")
)
...
import  SubtitleToAudio.core  # noqa
...
project = " SubtitleToAudio"
_full_version =  SubtitleToAudio.core.__version__
author =  SubtitleToAudio.core.__author__
copyright =  SubtitleToAudio.core.__copyright__
...
htmlhelp_basename = " SubtitleToAudio-doc"
...
texinfo_documents = [
    (
        ...
        author,
        " SubtitleToAudio",
         SubtitleToAudio.core.__descr__,
        "Miscellaneous",
    ),
]
